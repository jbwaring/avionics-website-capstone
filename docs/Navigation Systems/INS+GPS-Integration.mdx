...
:::tip Key Points
Using complementary filtering, we can combine the data from two independent sources of information and obtain a better state estimate. [[Collinson]](#2)

:::

### Kalman Filter  [[Navbook]](#1)
